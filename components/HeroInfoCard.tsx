...
export default function HeroInfoCard({
  ...
  return (
    <>
      <div
        className={
          "HeroInfoCard gradient-stroke !absolute z-20 flex h-[52px] w-fit items-center gap-3 rounded-xl bg-[linear-gradient(160deg,_#1b1c3628,_#70717a28_80%)] p-2 backdrop-blur-[10px] before:bg-[linear-gradient(160deg,_#ffffff11,_#ffffff26)]"
        }
        style={{ ...positons }}
      >
        <div
